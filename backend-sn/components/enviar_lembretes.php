...
// gerarCorpoRelatorioQuinzenal() vive em relatorio_utils.php (require no
// topo do ficheiro) — assim também pode ser usada por um envio de
// pré-visualização, sem duplicar a lógica.
